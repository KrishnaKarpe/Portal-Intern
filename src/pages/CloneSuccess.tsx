      ...
      <Card className="w-full max-w-2xl shadow-xl border-green-200">
        <CardHeader className="text-center bg-green-50 border-b">
          ...
          <p className="text-green-600 mt-2">
            Your product has been successfully cloned to the target organization
          </p>
        </CardHeader>
        ...
        <CardContent className="pt-6 space-y-6">
              ...
              <div className="grid gap-3 text-sm">
                ...
                {productData.displayName && (
                  <div className="flex justify-between">
                    ...
                    <span className="text-gray-800">{productData.displayName}</span>
                  </div>
                )}
                ...
                {productData.description && (
                  <div className="flex justify-between">
                    ...
                    <span className="text-gray-800">{productData.description}</span>
                  </div>
                )}
                
                {productData.environments && (
                  <div className="flex justify-between">
                    <span className="font-medium text-gray-600">Environments:</span>
                    <span className="text-gray-800">
                      {Array.isArray(productData.environments) 
                        ? productData.environments.join(', ') 
                        : productData.environments}
                    </span>
                  </div>
                )}
          ...
          >
            ...
            <ul className="text-sm text-blue-700 space-y-1">
              <li>• Check your Apigee console to verify the product</li>
              <li>• Configure any additional settings if needed</li>
              <li>• Test the API product in the target environment</li>
            </ul>
          </motion.div>
